...
class Tracker:
    ...
    def draw_triangle(self, frame, bbox, color):
        ...
        cv2.drawContours(frame, [triangle_points], contourIdx=0, color=color, thickness=cv2.FILLED)
        cv2.drawContours(frame, [triangle_points], contourIdx=0, color=(0,0,0), thickness=2)
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        if track_id is not None:
            ...
            # If players number is too large, put it more to the left
            x1_text = x1_rect + 12
            if track_id > 99:
                x1_text -= 10
