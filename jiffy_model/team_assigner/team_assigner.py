...
class TeamAssigner:
    ...
    def clustering_model(self, top_half_img):
    ...
    def get_player_color(self, frame, bbox):
        ...
        # KMeans clustering
        kmeans = self.clustering_model(top_half_img)
        
        # Get the cluster labels for each pixel
        clustered_labels = kmeans.labels_
        clustered_img = clustered_labels.reshape(top_half_img.shape[0], top_half_img.shape[1])
